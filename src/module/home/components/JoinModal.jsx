...
import { X, CheckCircle2, ChevronRight, Bell, Zap, ShieldCheck } from "lucide-react";
                        ...
                        <div className="flex flex-col md:flex-row h-full">
                            ...
                            <div className="hidden md:flex md:w-[40%] bg-footerBg relative overflow-hidden p-8 flex-col justify-between">
                                ...
                                <div className="relative z-10 pt-8 opacity-50 flex items-center gap-2">
                                    <span className="text-white text-xs font-bold uppercase tracking-widest italic">Australia First</span>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 p-8 sm:p-10 md:p-12">
                                {!isSubmitted ? (
                                    <>
                                        <div className="mb-8">
                                            ...
                                            <p className="text-slate-500 text-base leading-relaxed">
                                                Match At First Swipe is launching soon across Australia. Enter your email to secure your spot and premium rewards.
                                            </p>
                                        </div>
                                        ...
                                        <form onSubmit={handleSubmit} className="space-y-4">
                                            ...
                                            <button
                                                type="submit"
                                                disabled={isLoading}
                                                className="w-full py-4 bg-gradient-to-r from-[#46C7CD] to-[#00B4D8] text-white font-bold rounded-2xl shadow-lg shadow-[#46C7CD]/25 flex items-center justify-center gap-2 group hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-70 disabled:hover:scale-100"
                                            >
                                                {isLoading ? (
                                        ...
                                        <p className="text-[11px] text-slate-400 mt-6 text-center leading-relaxed">
                                            By signing up, you agree to receive launch notifications. No spam, we promise.
                                        </p>
                                    </>
                                ) : (
                                    <div className="text-center py-6 sm:py-10 animate-in fade-in zoom-in duration-500">
                                        ...
                                        <h2 className="text-3xl font-bold text-slate-900 mb-4 tracking-tight">You're on the list!</h2>
                                        <p className="text-slate-500 text-lg leading-relaxed mb-8">
                                            Check your inbox soon for your exclusive invitation to Join MAFS Australia.
                                        </p>
                                        <button
                                            onClick={onClose}
