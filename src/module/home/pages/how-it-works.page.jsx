                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-14 md:pt-16 pb-12 sm:pb-20 md:pb-24">
                    ...
                    <div className="flex flex-col gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6">
                        <div className="inline-flex items-center gap-2 sm:gap-2.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/5 border border-white/10 w-fit backdrop-blur-sm">
                            <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#46C7CD]" />
                            <span className="text-[10px] sm:text-xs md:text-sm font-bold text-white uppercase tracking-wider">The MAFS Journey</span>
                        </div>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16">
                <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-10 xl:gap-14 2xl:gap-20">
                            ...
                            >
                                <div className="flex items-center gap-2.5 sm:gap-3">
                                    ...
                                    <span className="font-bold text-slate-900 text-xs sm:text-sm">
                                        {sections.find(s => s.id === activeSection)?.title || "Step-by-Step Guide"}
                                    </span>
                                </div>
                                <ChevronRight className={`w-4 h-4 sm:w-5 sm:h-5 text-slate-400 transition-transform duration-300 ${isMobileMenuOpen ? "rotate-90" : ""}`} />
                            </button>
                                ...
                                <>
                                    ...
                                    <div className="relative z-30 mt-2 bg-white rounded-xl sm:rounded-2xl border border-slate-200/50 shadow-lg overflow-hidden animate-[fadeIn_0.2s_ease]">
                                        ...
                                        <div className="border-t border-slate-100 p-3 sm:p-4 space-y-2 sm:space-y-2.5">
                                            <Link to="/features" className="flex items-center justify-between text-xs sm:text-sm text-slate-600 hover:text-[#46C7CD] px-1 group transition-colors">
                                                Check Features
                                                <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-300 group-hover:text-[#46C7CD] transition-all" />
                                            </Link>
                                            <Link to="/waitlist" className="flex items-center justify-between text-xs sm:text-sm text-slate-600 hover:text-[#46C7CD] px-1 group transition-colors">
                                                Join waitlist
                                                <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-300 group-hover:text-[#46C7CD] transition-all" />
                                            </Link>
                                        </div>
                    ...
                    <main className="flex-1 min-w-0 space-y-10 sm:space-y-12 md:space-y-16">
                        {sections.map((section, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="space-y-6 sm:space-y-8 pl-0 sm:pl-16 md:pl-20">
                                        {section.content.map((item, i) => {
                                            if (item.isDashboard) {
                                                return (
                                                    <div key={i} className="my-6 sm:my-8 md:my-10 -ml-0 sm:-ml-16 md:-ml-20">
                                                        <div className="bg-white rounded-2xl sm:rounded-3xl md:rounded-[40px] border border-slate-200/50 shadow-xl overflow-hidden p-2 sm:p-3 md:p-4 lg:p-0">
                                                            <div className="w-full overflow-x-auto">
                                                                <Dashboard />
                                                            </div>
                                                        </div>
                                                        <p className="text-center text-[10px] sm:text-xs text-slate-400 mt-4 sm:mt-5 md:mt-6 font-medium px-4">Interactive Demo: Try swiping to see the algorithm in action</p>
                                                    </div>
                                                );
                                            }
                                            return (
                                                <div key={i} className="max-w-3xl">
                                                    <h4 className="text-base sm:text-lg md:text-xl font-bold text-slate-800 mb-2 sm:mb-3">
                                                        {item.subtitle}
                                                    </h4>
                        ...
                        {/* CTA Section */}
                        <div className="mt-12 sm:mt-16 md:mt-24 p-5 sm:p-8 md:p-12 text-center max-w-4xl mx-auto sm:ml-16 border-2 border-dashed border-slate-200 rounded-2xl sm:rounded-3xl md:rounded-[40px]">
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 mb-4 sm:mb-5 md:mb-6">Your perfect match is just a few steps away.</h3>
                            <Link
                                to="/waitlist"
                                className="inline-flex items-center gap-2 bg-gradient-to-r from-[#46C7CD] to-[#00B4D8] text-white font-bold px-6 sm:px-8 md:px-10 py-3 sm:py-3.5 md:py-4 rounded-full hover:shadow-xl hover:shadow-[#46C7CD]/30 transition-all transform hover:-translate-y-1 text-sm sm:text-base"
                            >
                                Join the Waitlist Now
