...
const WaitlistPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F0F1F3]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-14 md:pt-16 pb-14 sm:pb-20 md:pb-24">
                    ...
                    <div className="flex flex-col gap-4 sm:gap-6 mb-6">
                        <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/5 border border-white/10 w-fit backdrop-blur-sm">
                            ...
                            <span className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Early Access</span>
                        </div>
                        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[64px] font-bold text-white tracking-tight leading-[1.1]">
                            Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#46C7CD] to-[#00B4D8]">Waitlist</span>
                        </h1>
                    </div>

                    <p className="text-white/60 text-base sm:text-lg max-w-2xl leading-relaxed">
                        Match At First Swipe is launching soon in Australia. Join thousands of early adopters and be the first to experience a dating app designed for real chemistry.
                    </p>
                </div>
            ...
            {/* ===== WAITLIST SECTION ===== */}
            <main className="relative z-10 -mt-8 sm:-mt-12 md:-mt-16 pb-16 sm:pb-24">
                <WaitlistSection />
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 sm:mt-24">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                        {[
                            { icon: Users, title: "Priority Matchmaking", desc: "Waitlist members get moved to the top of the stack for the first month of launch." },
                            { icon: Bell, title: "Launch Notifications", desc: "Get an exclusive invite code to join before the general public in your city." },
                            { icon: Users, title: "Charter Member Badge", desc: "A permanent unique badge on your profile showing you were here from day one." }
                        ].map((item, i) => (
                            <div key={i} className="bg-white rounded-3xl p-8 border border-slate-200/50 shadow-sm text-center group">
