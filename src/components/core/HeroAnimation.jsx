    ...
    <div className="overflow-x-hidden w-full bg-[#F0F1F3]">
      ...
      <section id="hero-section" className="relative min-h-screen">
        <div className="absolute inset-0 z-0">
          <img src="/Background.png" alt="Hero Background" className="w-full h-full object-cover" />
        </div>
        <div className="absolute inset-0 z-[1] bg-gradient-to-b from-black/20 via-black/10 to-transparent" />

        {/* Decorative Stars */}
        <div className="absolute inset-0 z-[2] overflow-hidden pointer-events-none">
          <div className="absolute top-[15%] left-[8%] text-white/30 text-xl sm:text-2xl">✦</div>
          <div className="absolute top-[35%] left-[5%] text-white/25 text-base sm:text-lg">✦</div>
          <div className="absolute top-[20%] right-[12%] text-white/30 text-xl sm:text-2xl">✦</div>
          <div className="absolute bottom-[45%] left-[10%] text-white/20 text-lg">✦</div>
          <div className="absolute bottom-[50%] right-[15%] text-white/25 text-xl">✦</div>
        </div>

        {/* Logo */}
        <div className="absolute top-6 sm:top-8 md:top-10 left-6 sm:left-8 md:left-10 lg:left-14 z-30">
          <img src="/Vector (4).png" alt="Logo" className="h-7 sm:h-8 md:h-10 w-auto" />
        </div>
        ...
        <div className="relative z-20 w-full min-h-screen flex flex-col justify-center px-6 sm:px-8 md:px-10 lg:px-14 pt-24 sm:pt-28 md:pt-32 pb-10 sm:pb-14 md:pb-16">
          <div className="text-center mb-10 sm:mb-14 md:mb-16 lg:mb-20">
            ...
            <p className="text-white/90 text-sm sm:text-base md:text-lg font-medium tracking-wide">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-6 xl:gap-10 items-end max-w-[1200px] mx-auto w-full">
            ...
            <div className="flex flex-col items-center lg:items-start gap-6 sm:gap-8 order-2 lg:order-1">
              <div className="text-center lg:text-left">
                <p className="text-white/70 text-xs sm:text-[13px] mb-2.5 font-medium tracking-wide uppercase">Launching soon on</p>
                <div className="flex gap-2.5 justify-center lg:justify-start">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform cursor-pointer">
                    <img src="/Frame 120.png" className="w-5 h-5 sm:w-6 sm:h-6 object-contain" alt="App Store" />
                  </div>
                  <div className="w-10 h-10 sm:w-11 sm:h-11 bg-white rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform cursor-pointer">
                    <img src="/Frame 121.png" className="w-5 h-5 sm:w-6 sm:h-6 object-contain" alt="Play Store" />
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center lg:items-start">
                <div className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 group">
                  ...
                  <svg className="absolute inset-0 w-full h-full origin-center animate-[spin_1s_linear_infinite] rotate-svg" viewBox="0 0 200 200">
                    <defs>
                      <path id="circlePath" d="M 100, 100 m -75, 0 a 75,75 0 1,1 150,0 a 75,75 0 1,1 -150,0" />
                    </defs>
                    <text fill="white" fontSize="20" fontWeight="500" letterSpacing="2">
                      <textPath href="#circlePath" startOffset="0%">Scroll To Explore More</textPath>
                    </text>
                  </svg>
            ...
            <div className="flex justify-center items-end order-1 lg:order-2">
              <div id="phone-hero" className="pointer-events-none">
                <img src="/Phone.png" alt="Phone" className="w-[200px] sm:w-[220px] md:w-[260px] lg:w-[280px] xl:w-[300px] drop-shadow-[0_25px_50px_rgba(0,0,0,0.15)]" />
              </div>
            </div>
            ...
            <div className="flex flex-col items-center lg:items-end text-center lg:text-right gap-3 sm:gap-4 order-3">
              <div>
                ...
                <p className="text-white/75 text-xs sm:text-[13px] font-medium flex items-center justify-center lg:justify-end gap-1.5">
      ...
      <section
        id="benefits-section"
        className="relative min-h-screen flex items-center justify-center py-16 sm:py-20 md:py-24 overflow-hidden px-4"
      >
        <div
        ...
        >
          ...
          <div className="absolute inset-0 rounded-full border border-[#E5E7EB] bg-gradient-to-b from-white/80 to-transparent flex items-center justify-center">
            ...
            >
              <defs>
                <linearGradient id="arcGradientOuter" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <g className="spin-content-cw" style={{ transformOrigin: "100px 100px" }}>
                <circle
                  cx="100"
                  cy="100"
                  r="99"
            ...
            <div className="w-[72%] h-[72%] rounded-full border border-[#E5E7EB]/60 bg-white/40 flex items-center justify-center relative">
              ...
              >
                ...
                <g className="spin-content-ccw" style={{ transformOrigin: "100px 100px" }}>
                  <circle
                    cx="100"
                    cy="100"
                    r="99" 
